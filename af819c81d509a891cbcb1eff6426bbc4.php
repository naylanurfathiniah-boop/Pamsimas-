<?php $__env->startSection('title', 'Input Meteran Baru'); ?>
<?php $__env->startSection('page_title', 'Input Meteran Baru'); ?>
<?php $__env->startSection('page_subtitle', 'Catat pemakaian air + foto bukti meteran'); ?>

<?php $__env->startSection('content'); ?>

    <div class="mb-4">
        <a href="<?php echo e(route('petugas.meteran.index')); ?>"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5">
                ...
                <form method="GET" action="<?php echo e(route('petugas.meteran.create')); ?>" id="formPilih">
                    <?php if(request('bulan')): ?><input type="hidden" name="bulan" value="<?php echo e(request('bulan')); ?>"><?php endif; ?>
                    <?php if(request('tahun')): ?><input type="hidden" name="tahun" value="<?php echo e(request('tahun')); ?>"><?php endif; ?>
                    <input type="hidden" name="pelanggan_id" id="hiddenPelangganId" value="<?php echo e(request('pelanggan_id')); ?>">
                    ...
                    <div class="relative">
                        ...
                        <div id="dropdownPelanggan"
                            ...
                            <?php $__currentLoopData = $pelangganList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="pelanggan-option px-4 py-3 cursor-pointer hover:bg-brand-50 dark:hover:bg-brand-900/20 border-b border-gray-50 dark:border-gray-800 last:border-0 transition-colors"
                                    data-id="<?php echo e($plg->id); ?>" data-nama="<?php echo e($plg->nama_pelanggan); ?>"
                                    data-nomor="<?php echo e($plg->nomor_pelanggan); ?>">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-800 dark:text-white">
                                                <?php echo e($plg->nama_pelanggan); ?></p>
            ...
            <?php if($selectedPelanggan): ?>
                ...
                <div class="bg-brand-50 dark:bg-brand-900/20 rounded-2xl border border-brand-100 dark:border-brand-800 p-4">
                    <div class="grid grid-cols-2 gap-3 text-sm">
                        <div>
                            ...
                            <p class="font-semibold text-brand-800 dark:text-brand-200"><?php echo e($selectedPelanggan->nama_pelanggan); ?>
                        ...
                        <div>
                            ...
                            <p class="font-mono font-semibold text-brand-800 dark:text-brand-200">
                                <?php echo e($selectedPelanggan->nomor_pelanggan); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-brand-500 dark:text-brand-400 mb-0.5">Alamat</p>
                            <p class="text-brand-700 dark:text-brand-300 text-xs"><?php echo e($selectedPelanggan->alamat); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-brand-500 dark:text-brand-400 mb-0.5">Angka Awal Bulan Ini</p>
                            <p class="font-bold text-brand-800 dark:text-brand-200 text-xl"><?php echo e(number_format($angkaAwalRef)); ?>
                ...
                <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5"
                    x-data="{
                        angkaAwal: <?php echo e($angkaAwalRef); ?>,
                        angkaAkhir: <?php echo e(old('angka_akhir', 0)); ?>,
                        pemakaian: 0,
                        totalTagihan: 0,
                        biayaPokok: 0,
                        tarifBlok1: <?php echo e($tarifConfig['tarif_blok1']); ?>,
                        tarifBlok2: <?php echo e($tarifConfig['tarif_blok2']); ?>,
                        tarifBlok3: <?php echo e($tarifConfig['tarif_blok3']); ?>,
                        biayaAdmin: <?php echo e($tarifConfig['biaya_admin']); ?>,
                        fotoPreview: null,
                        fotoNama: '',
                        init(){ this.hitung(); },
                        hitung(){
                    ...
                    <form method="POST" action="<?php echo e(route('petugas.meteran.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="pelanggan_id" value="<?php echo e($selectedPelanggan->id); ?>">
                            ...
                            <div>
                                ...
                                <select name="bulan" required
                                    ...
                                    <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($b); ?>" <?php echo e(old('bulan', now()->month) == $b ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="tahun" required
                                    ...
                                    <?php $__currentLoopData = range(now()->year, now()->year - 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($y); ?>" <?php echo e(old('tahun', now()->year) == $y ? 'selected' : ''); ?>><?php echo e($y); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="angka_akhir" x-model.number="angkaAkhir" @input="hitung()"
                                        value="<?php echo e(old('angka_akhir')); ?>" step="0.01" required placeholder="Baca dari meteran..."
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Tanggal Baca
                                <span class="text-red-500">*</span></label>
                            <input type="date" name="tanggal_baca" value="<?php echo e(old('tanggal_baca', now()->toDateString())); ?>"
                                max="<?php echo e(now()->toDateString()); ?>" required
                                class="w-full py-2.5 px-4 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-500 transition-all">
                            <?php $__errorArgs = ['tanggal_baca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="mt-1 text-xs text-red-500"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="keterangan" rows="2" placeholder="Kondisi meteran, catatan khusus, dll..."
                                class="w-full py-2.5 px-4 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-800 dark:text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none transition-all"><?php echo e(old('keterangan')); ?></textarea>
                        </div>
        ...
        <div class="space-y-4">
            <?php if($selectedPelanggan): ?>
                ...
                <div class="bg-gradient-to-br from-brand-800 to-brand-600 rounded-2xl p-5 text-white sticky top-20" x-data="{
                    angkaAwal: <?php echo e($angkaAwalRef); ?>, angkaAkhir: 0, 
                    tarifBlok1: <?php echo e($tarifConfig['tarif_blok1']); ?>, 
                    tarifBlok2: <?php echo e($tarifConfig['tarif_blok2']); ?>, 
                    tarifBlok3: <?php echo e($tarifConfig['tarif_blok3']); ?>, 
                    biayaAdmin: <?php echo e($tarifConfig['biaya_admin']); ?>, 
                    ...
                    <div class="space-y-2 text-sm border-t border-brand-600 pt-4">
                        <div class="flex justify-between"><span class="text-brand-300">Angka Awal</span><span
                                class="font-semibold"><?php echo e(number_format($angkaAwalRef)); ?> m³</span></div>
                ...
                <div class="space-y-2">
                    ...
                    <div
                        ...
                        <p class="text-sm font-bold text-emerald-700">
                            Rp <?php echo e(number_format($tarifConfig['tarif_blok1'], 0, ',', '.')); ?> flat
                        </p>
                    </div>
                    ...
                    <div class="flex items-center justify-between py-2 px-3 rounded-xl bg-blue-50 border border-blue-100">
                        ...
                        <p class="text-sm font-bold text-blue-700">
                            Rp <?php echo e(number_format($tarifConfig['tarif_blok2'], 0, ',', '.')); ?>/m³
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm font-bold text-orange-700">
                            Rp <?php echo e(number_format($tarifConfig['tarif_blok3'], 0, ',', '.')); ?>/m³
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-sm font-bold text-purple-700">
                            Rp <?php echo e(number_format($tarifConfig['biaya_admin'], 0, ',', '.')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PamsimasBumnag\resources\views/petugas/meteran/create.blade.php ENDPATH**/ ?>