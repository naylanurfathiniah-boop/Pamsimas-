...
<?php $__env->startSection('page_title', 'Dashboard Petugas'); ?>
<?php $__env->startSection('page_subtitle', 'Selamat datang, ' . auth()->user()->name . ' · ' . \Carbon\Carbon::now()->translatedFormat('d F Y')); ?>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="stat-card bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
        ...
        <p class="text-2xl font-extrabold text-gray-900 dark:text-white"><?php echo e(number_format($meteranBulanIni)); ?></p>
    ...
    <div class="stat-card bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
        ...
        <p class="text-2xl font-extrabold text-gray-900 dark:text-white"><?php echo e(number_format($sudahInputMeteran)); ?></p>
    ...
    <div class="stat-card bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
        ...
        <p class="text-2xl font-extrabold text-gray-900 dark:text-white"><?php echo e(number_format($belumInputMeteran)); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 shadow-sm">
        ...
        <div class="space-y-2.5">
            ...
            <a href="<?php echo e(route('petugas.riwayat.index')); ?>"
            ...
            <a href="<?php echo e(route('petugas.pengaduan.index')); ?>"
                ...
                <div>
                    ...
                    <p class="text-xs text-orange-600 dark:text-orange-400"><?php echo e($pengaduanBaru); ?> pengaduan baru</p>
                </div>
            </a>
        </div>
    </div>
...
<div class="mt-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
    <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('petugas.riwayat.index')); ?>" class="text-brand-600 dark:text-brand-400 text-xs hover:underline">Lihat semua →</a>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                <?php $__currentLoopData = $meteranTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    <td class="px-5 py-3">
                        <p class="font-medium text-gray-800 dark:text-gray-200"><?php echo e($m->pelanggan->nama_pelanggan); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($m->pelanggan->nomor_pelanggan); ?></p>
                    </td>
                    <td class="px-3 py-3 text-center text-xs text-gray-600 dark:text-gray-400">
                        <?php echo e(\App\Services\TagihanService::namaBulan($m->bulan)); ?> <?php echo e($m->tahun); ?>

                    </td>
                    <td class="px-3 py-3 text-center text-gray-600 dark:text-gray-400"><?php echo e(number_format($m->angka_awal)); ?></td>
                    <td class="px-3 py-3 text-center text-gray-600 dark:text-gray-400"><?php echo e(number_format($m->angka_akhir)); ?></td>
                    <td class="px-3 py-3 text-center">
                        <span class="font-semibold text-brand-600 dark:text-brand-400"><?php echo e(number_format($m->pemakaian, 1)); ?> m³</span>
                    </td>
                    <td class="px-5 py-3 text-right text-xs text-gray-400"><?php echo e($m->tanggal_baca->format('d/m/Y')); ?></td>
                </tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('meteranChart').getContext('2d'), {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($chartHari, 15, 512) ?>,
            datasets: [{
                label: 'Pemakaian (m³)',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PamsimasBumnag\resources\views/petugas/dashboard.blade.php ENDPATH**/ ?>