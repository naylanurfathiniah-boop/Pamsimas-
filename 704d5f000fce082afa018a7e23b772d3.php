...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <select name="jorong_id" class="sel-wilayah w-full px-3 py-2.5 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500">
            ...
            <option value="<?php echo e($j->id); ?>" <?php echo e(old('jorong_id') == $j->id ? 'selected' : ''); ?>><?php echo e($j->nama_jorong); ?></option>
...
<script>
const defLat   = <?php echo e(old('latitude',  isset($pelanggan) ? ($pelanggan->latitude  ?? -0.1277) : -0.1277)); ?>;
const defLng   = <?php echo e(old('longitude', isset($pelanggan) ? ($pelanggan->longitude ?? 100.1746) : 100.1746)); ?>;
const adaKoord = <?php echo e((old('latitude', isset($pelanggan) ? ($pelanggan->latitude ?? null) : null)) ? 'true' : 'false'); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PamsimasBumnag\resources\views/admin/pelanggan/create.blade.php ENDPATH**/ ?>